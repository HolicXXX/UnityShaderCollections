...
Shader "Custom/NPR/Hatching" {
	...
	SubShader {
		...
		UsePass "Custom/NPR/ToonShading/OUTLINE"
		...
		pass {
			...
			v2f vert (a2v v) {
				...
				if (hatchFactor > 6.0) {
					...
					o.hatchWeights1.z = hatchFactor - 2.0;
					o.hatchWeights1.x = 1 - o.hatchWeights1.z;
				} else if (hatchFactor > 1.0) {
					o.hatchWeights1.x = hatchFactor - 1.0;
					o.hatchWeights1.y = 1 - o.hatchWeights1.x;
				} else {
					o.hatchWeights1.y = hatchFactor;
					o.hatchWeights0.z = 1 - o.hatchWeights1.y;
				}
